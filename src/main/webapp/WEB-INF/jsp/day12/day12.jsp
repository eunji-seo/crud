...
<body>
	...
	<input type="text" id="currentPrice" name="currentPrice" placeholder="currentPrice">
	<input type="text" id="faceValue" name="faceValue" placeholder="faceValue">
	<input type="text" id="fiveDayHigh" name="fiveDayHigh" placeholder="fiveDayHigh">
	<input type="text" id="twentyDayHigh" name="twentyDayHigh" placeholder="twentyDayHigh">
	<input type="text" id="fiftyTowWeeksHigh" name="fiftyTowWeeksHigh" placeholder="fiftyTowWeeksHigh">
	<input type="text" id="listingdate" name="listingdate" placeholder="listingdate">
	<input type="text" id="listedOrder" name="listedOrder" placeholder="listedOrder">
	<input type="text" id="marketCap" name="marketCap" placeholder="marketCap">
	<input type="text" id="netProfit" name="netProfit" placeholder="netProfit">
	<input type="text" id="PER" name="PER" placeholder="PER">
	<input type="text" id="PBR" name="PBR" placeholder="PBR">
