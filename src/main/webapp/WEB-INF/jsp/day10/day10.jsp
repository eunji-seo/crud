...
<body>
	...
	<label for="terms">이용약관 동의<input type="checkbox" id="terms" name="terms" value="동의함"></label>
	<label for="privacy">개인정보 동의</label><input type="checkbox" id="privacy" name="privacy" value="동의함" ></label>
	<input type="text" id="loginId" name="loginId" placeholder="loginId">
	<input type="password" id="password" name="password" placeholder="password">
	<input type="text" id="gender" name="gender" placeholder="gender">
	<input type="text" id="email" name="email" placeholder="email">
	<label for="creditAgreement">신용 동의</label><input type="checkbox" id="creditAgreement" name="creditAgreement" value="동의함"></label>
